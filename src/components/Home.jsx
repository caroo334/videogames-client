  ...
  return (
    <div className="home-container">
      ...
      <div>
        ...
        {allGenres && (
          <select
            className="select-alf"
            onChange={(e) => handleSelectGenres(e)}
          >
            <>
              <option value={null}>Todos</option>
              {allGenres.map((genre, index) => (
                <option key={`${genre.id}_${index}`} value={genre.name}>
                  {genre.name}
                </option>
              ))}
            </>
                    ...
                    <Card
                      ...
                      image={
                        a.background_image ? (
                          ...
                          <img src="https://i.pinimg.com/originals/b3/85/29/b3852980264d563f343cfa0f2de41833.jpg" />
                        )
                      }
                      rating={a.rating}
                      reviews={a.reviews_text_count}
                      key={a.id}
                    />
                  </div>
                </Link>
